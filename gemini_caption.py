...
# ================= 配置区域 =================
# 从 config.json 读取密钥和 API 站点配置
_CONFIG_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "config.json")
with open(_CONFIG_PATH, "r", encoding="utf-8") as _f:
    _config = json.load(_f)

API_KEY = _config["caption_api"]["api_key"]
BASE_URL = _config["caption_api"]["base_url"]
MODEL_NAME = _config["caption_api"]["model_name"]
...
SUMMARY_API_KEY = _config["summary_api"]["api_key"]
SUMMARY_BASE_URL = _config["summary_api"]["base_url"]
SUMMARY_MODEL_NAME = _config["summary_api"]["model_name"]
